...
const dApps = [
  { name: 'BaseSwap', url: 'https://baseswap.io', description: 'Swap tokens easily on Base.' },
  { name: 'BaseNFT', url: 'https://basenft.io', description: 'Explore NFTs on Base.' },
  { name: 'Aerodrome', url: 'https://aerodrome.finance', description: 'Decentralized exchange on Base.' },
];
